    ...
    <footer className="w-full lg:max-w-screen-md flex flex-col justify-center items-center mx-auto">
      ...
      <AnimationContainer customClassName="w-full grid place-items-center grid-cols-3 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3">
        <div className="flex flex-col space-y-4">
          <Link
            href="/"
            className="flex items-center gap-2 text-blue-500 hover:text-gray-600 transition ease"
          >
            <svg
          ...
          <Link
            href="/about"
            className="flex items-center gap-2 text-red-500 hover:text-gray-600 transition ease"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
          ...
          <Link
            href="/projects"
            className="flex items-center gap-2 text-green-500 hover:text-gray-600 transition ease"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
        ...
        <div className="flex flex-col space-y-4 ">
          <ExternalLink href="https://github.com/DIY0R">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="https://www.linkedin.com/in/diyorbek-sobirov/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
        ...
        <div className="flex flex-col space-y-4">
          ...
          >
            ...
            <p className="text-purple-500"> Blog</p>
          </Link>

          <ExternalLink href="https://t.me/diyor_coffee">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
            ...
            <p className="text-teal-500">Contact</p>
          </ExternalLink>

          <ExternalLink href="https://tashkent.hh.uz/resume/bc80b25bff093932480039ed1f56673143776a">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
            ...
            <p className="text-indigo-500"> My CV</p>
          </ExternalLink>
        </div>
      </AnimationContainer>
    </footer>
